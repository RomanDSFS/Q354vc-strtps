"""Remove contacts and company_name from startups

Revision ID: 7f73aedb8924
Revises: 0e8aa16b9232
Create Date: 2025-03-13 19:56:01.926834
...
revision: str = '7f73aedb8924'
down_revision: Union[str, None] = '0e8aa16b9232'
...
def upgrade() -> None:
    ...
    op.alter_column('analysis_results', 'file_path',
               existing_type=sa.TEXT(),
               type_=sa.String(),
               existing_nullable=False)
    op.drop_constraint('analysis_results_new_file_path_key', 'analysis_results', type_='unique')
...
def downgrade() -> None:
    ...
    op.alter_column('startups', 'founder_id',
               existing_type=sa.UUID(),
               nullable=True)
    op.create_unique_constraint('analysis_results_new_file_path_key', 'analysis_results', ['file_path'])
    op.alter_column('analysis_results', 'file_path',
               existing_type=sa.String(),
               type_=sa.TEXT(),
               existing_nullable=False)
